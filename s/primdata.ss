...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
 ...
 ; c..r non-alphabetic so marks come before references
  ...
  (make-string [sig [(length) (length char) -> (string)]] [flags alloc ieee r5rs safeongoodargs])
  ...
  (make-vector [sig [(length) (length ptr) -> (vector)]] [flags alloc ieee r5rs safeongoodargs])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs bytevectors)] [flags primitive proc])
  ...
  (make-bytevector [sig [(length) (length u8/s8) -> (bytevector)]] [flags alloc safeongoodargs])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (make-flvector [sig [(length) (length flonum) -> (flvector)]] [flags alloc safeongoodargs])
  (make-fxvector [sig [(length) (length fixnum) -> (fxvector)]] [flags alloc safeongoodargs])
  (make-guardian [sig [() (ptr) -> (procedure)]] [flags alloc cp02])
  (make-hash-table [sig [() (ptr) -> (old-hash-table)]] [flags unrestricted alloc])
  (make-immobile-bytevector [sig [(length) (length u8/s8) -> (bytevector)]] [flags alloc safeongoodargs])
  (make-immobile-vector [sig [(length) (length ptr) -> (vector)]] [flags alloc safeongoodargs])
  ...
  (make-reference-bytevector [sig [(length) -> (bytevector)]] [flags alloc safeongoodargs])
