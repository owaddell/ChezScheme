...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($make-record-type-descriptor/interfaces [flags pure alloc cp02])
  ...
  ($record-accessor/proxy #;[sig [(rtd sub-index) (rtd rtd sub-index) -> (procedure)]] [flags pure alloc cp02])
  ($record-equal-procedure [flags discard])
  ($record-hash-procedure [flags discard])
  ($record-mutator/proxy #;[sig [(rtd sub-index) (rtd rtd sub-index) -> (procedure)]] [flags pure alloc cp02])
  ($record-oops #;[sig [(who sub-ptr rtd) -> (bottom)]] [flags abort-op])
  ($record-type-descriptor [flags pure mifoldable discard true])
  ($record-type-interfaces #;[sig [(rtd) -> (vector)]] [flags pure discard true])
  ($record-type-field-offsets [flags pure mifoldable discard true cp02])
  ($reloc [flags])
  ($remake-rtd [flags])
  ($report-string [flags])
  ...
  ($trans-open-interface [flags])
  ($trans-record-type-descriptor [flags])
  ($trans-record-constructor-descriptor [flags])
